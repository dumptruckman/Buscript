package buscript.util.fscript.introspection;
...
import buscript.util.fscript.FSObject;
...
public class MethodMap
{
     ...
     *  @throws buscript.util.fscript.introspection.MethodMap.AmbiguousException if there is more than one maximally
